...
function update(dt){
  ...
  clock-=dt;if(phase!=='buy')updatePlayer(dt);updateGunMotion(dt);
...
function drawGun(w,h){
  ...
  const originX=w*(pistol?.64:.78)*(1-ads)+aimX*ads;
