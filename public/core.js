...
// Original competitive layouts with two objective zones, a clearly marked MID route and flanks.
// They are intentionally independent of Counter-Strike or Valve map data.
const specs = [
  { id:'dunes', name:'ДЮНИ', desc:'Піщаний вузол із довгими флангами та відкритим центром.', tag:'ПУСТЕЛЬНИЙ КОМПЛЕКС', label:'ТРИ МАРШРУТИ', wall:'#b69662', light:'#eedcab', sky:'#c6ae7c', floor:'#907b5a', accent:'#5e8c8b', blocks:[[6,3,2,6,1],[11,2,3,3,1],[17,3,3,5,2],[3,10,4,2,2],[9,8,3,5,1],[14,10,3,2,3],[18,11,3,3,1],[5,16,3,4,1],[10,17,5,2,2],[17,17,2,4,1],[7,6,1,2,3]] },
  { id:'arcade', name:'АРКАДА', desc:'Криті переходи, арки й небезпечні повороти.', tag:'МІСЬКИЙ КВАРТАЛ', label:'КОНТРОЛЬ ЦЕНТРУ', wall:'#aa9276', light:'#e5d3ac', sky:'#b8a185', floor:'#756f61', accent:'#678d8a', blocks:[[5,2,2,7,1],[10,3,5,2,2],[17,3,3,5,1],[3,11,5,3,1],[9,10,2,5,3],[14,10,5,2,2],[19,12,2,4,1],[5,17,3,4,2],[11,16,3,5,1],[16,17,4,2,1],[8,6,1,2,3]] },
  ...
  { id:'market', name:'РИНОК', desc:'Кам’яний ринок: фонтан у MID, аркові бокові галереї й відкриті двори.', tag:'МІСЬКИЙ РИНОК', label:'ФОНТАН У MID', wall:'#a88364', light:'#e8cf9b', sky:'#b7835d', floor:'#735c49', accent:'#6d8d78', blocks:[[5,2,3,5,2],[11,2,4,2,1],[18,3,2,6,3],[3,10,4,2,1],[8,8,2,4,2],[14,8,2,4,2],[10,10,2,2,3],[17,11,4,2,1],[5,16,2,5,3],[10,16,4,2,1],[17,17,3,3,2],[8,14,2,2,1]] },
  ...
  { id:'palace', name:'ПАЛАЦ', desc:'Сонячний внутрішній двір, верхня тераса й три аркові проходи.', tag:'КОЛИШНЯ РЕЗИДЕНЦІЯ', label:'ВЕРХНЯ ТЕРАСА', wall:'#c8a471', light:'#f6dfad', sky:'#d39a61', floor:'#80654c', accent:'#4f8790', blue:[[2.5,4.5],[3.5,3.5],[3.5,5.5]], red:[[21.5,18.5],[20.5,19.5],[20.5,17.5]], blocks:[[5,2,3,3,2],[11,2,5,2,1],[18,3,3,5,3],[4,7,2,5,1],[8,7,2,3,2],[14,7,2,3,2],[10,10,4,2,3],[3,13,5,2,3],[8,13,2,3,2],[14,13,2,3,2],[18,12,2,5,1],[10,16,4,2,3],[5,18,3,3,1],[12,19,5,2,2]] }
];
const TACTICAL_LAYOUTS = {
  dunes:{a:{name:'ОАЗА',point:[6,17]},mid:{name:'КРИНИЦЯ',point:[12,13]},b:{name:'РАДАР',point:[18,6]}},
  arcade:{a:{name:'ТЕАТР',point:[6,18]},mid:{name:'АРКА',point:[12,12]},b:{name:'БАЛКОН',point:[18,6]}},
...
function nearestOpen(grid,[x,y]){
  ...
  for(let gy=1;gy<23;gy++)for(let gx=1;gx<23;gx++)if(grid[gy][gx]===0){const next=(gx+.5-x)**2+(gy+.5-y)**2;if(next<distance){distance=next;point=[gx+.5,gy+.5];}}
  return point;
}
export const MAPS = specs.map(s=>{
  ...
  return {...s,sites:{a:mark(tactical.a),b:mark(tactical.b)},mid:mark(tactical.mid),routes:['ЛІВИЙ','MID','ПРАВИЙ'],grid,blue:s.blue||[[2.5,3.5],[3.5,2.5],[3.5,4.5]],red:s.red||[[21.5,20.5],[20.5,21.5],[20.5,19.5]]};
});
