...
Мапи, ізометричні ілюстрації, спрайти операторів, текстури стін і звуки ефектів створені процедурно кодом цього проєкту. Моделі гранат у руках, SVG-ілюстрації закупівлі, дим, полум’я, спалахи та звуки гранат також створені кодом проєкту, без сторонніх ресурсів. Використані системні шрифти. Зовнішні бібліотеки, шрифти, аналітика та мережеві ресурси для запуску не потрібні.
...
«Mirage · Pixel», «Dust II · Pixel», «Overpass · Pixel», «Ancient · Pixel», «Inferno · Pixel», «Vertigo · Pixel», «Office · Pixel», «Cache · Pixel» та «Nuke · Pixel» — спрощені піксельні адаптації планувань за зображеннями, наданими користувачем. Геометрія і матеріали намальовані кодом; оригінальні файли мапи, текстури й логотипи Counter-Strike не включені.
